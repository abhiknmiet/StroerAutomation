package com.stroeer.testRunner;
...
@CucumberOptions(
		...
		features = {"src/test/resources/feature/Amazon.feature"}, glue = { "com.stroeer.steps" }, plugin = {
				"com.cucumber.listener.ExtentCucumberFormatter:",
				"rerun:src/cucumber-reports/rerun.txt" }, strict = true, dryRun = false, monochrome = true, tags = {})	


public class StroeerTestRunner extends AbstractTestNGCucumberTests {
	...
	public void setup() {
		...
		extentProperties.setReportPath(reportDir + "\\" + ParentStep.environment + "_" + ParentStep.executionId + "_SELENIUM"
		 + new SimpleDateFormat("yyyy.MM.dd.HH.mm.ss").format(new Date())
				+ ".htm");
		extentProperties.setProjectName("STROEER");
	}
